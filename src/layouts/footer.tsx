    ...
    <footer className="relative w-full">
      <div className="mx-auto w-full max-w-7xl px-8">
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">Frontier registry</a>. All
            Rights Reserved.
          </Typography>
          <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
            ...
            <Typography as="a" href="https://x.com/frontierdao" className="opacity-80 transition-opacity hover:opacity-100">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
