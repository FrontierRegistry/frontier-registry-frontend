    ...
    <footer className="relative w-[110%] bg-back-blue">
      <div className="mx-auto w-full max-w-7xl 2xl:px-8 px-14 py-8">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          ...
          <div className="grid grid-cols-3 justify-between gap-4">
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                <p className="block antialiased font-sans text-sm leading-normal text-white mb-3 font-medium opacity-70">
                  {title}
                </p>
                {items.map((link) => (
                  <li key={link}>
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <p className="block antialiased font-sans text-sm leading-normal mb-4 text-center font-normal text-blue-gray-900 md:mb-0">
            &copy; {currentYear}{" "}
            <Link
              to="https://iotlogistics.international"
              className="text-white text-base"
          ...
          <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
            ...
            <a
              href="https://linkedin.com/in/paigedonner"
              className="block antialiased font-sans text-base font-light leading-relaxed text-inherit opacity-80 transition-opacity hover:opacity-100"
            >
              <svg
            ...
            <a
              href="https://discord.com/invite/UQVVw8QWrV"
              className="block antialiased font-sans text-base font-light leading-relaxed text-inherit opacity-80 transition-opacity hover:opacity-100"
            >
              <svg
                className="h-5 w-5"
            ...
            <a
              href="https://github.com/FrontierRegistry"
              className="block antialiased font-sans text-base font-light leading-relaxed text-inherit opacity-80 transition-opacity hover:opacity-100"
            >
              <svg
                className="h-5 w-5"
